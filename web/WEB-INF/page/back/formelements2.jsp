...
<link rel="stylesheet" href="${contextPath}/static/dist/css/bootstrap-duallistbox.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/bootstrap-multiselect.min.css" />
...
<div class="row">
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right">Typeahead.min.js</label>
...
<script type="text/javascript">
	var scripts = [null,"${contextPath}/static/dist/js/jquery.bootstrap-duallistbox.min.js","${contextPath}/static/dist/js/jquery.raty.min.js","${contextPath}/static/dist/js/bootstrap-multiselect.min.js","${contextPath}/static/dist/js/select2.min.js","${contextPath}/static/dist/js/typeahead.jquery.min.js", null]
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	  //inline scripts related to this page
		...
		//typeahead.min.js
		//example taken from plugin's page at: https://twitter.github.io/typeahead.min.js/examples/
