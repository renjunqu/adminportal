...
<script type="text/javascript">
		var scripts = [ null, "${contextPath}/static/dist/js/jqGrid/jquery.jqGrid.min.js", "${contextPath}/static/dist/js/jqGrid/i18n/grid.locale-cn.min.js", "${contextPath}/static/dist/js/jquery-ui.custom.min.js",
		        		"${contextPath}/static/dist/js/jquery.ui.touch-punch.min.js", "${contextPath}/static/dist/js/markdown/markdown.min.js", "${contextPath}/static/dist/js/markdown/bootstrap-markdown.min.js",
		        		"${contextPath}/static/dist/js/jquery.hotkeys.min.js", "${contextPath}/static/dist/js/bootstrap-wysiwyg.min.js", "${contextPath}/static/dist/js/bootbox.min.js", "${contextPath}/static/dist/js/jquery.gritter.min.js", null ]
