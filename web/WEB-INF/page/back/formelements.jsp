...
<link rel="stylesheet" href="${contextPath}/static/dist/css/jquery-ui.custom.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/chosen.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/datepicker.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/bootstrap-timepicker.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/daterangepicker.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/bootstrap-datetimepicker.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/colorpicker.min.css" />
...
<script type="text/javascript">
	var scripts = [null,"${contextPath}/static/dist/js/jquery-ui.custom.min.js","${contextPath}/static/dist/js/jquery.ui.touch-punch.min.js","${contextPath}/static/dist/js/chosen.jquery.min.js","${contextPath}/static/dist/js/fuelux/fuelux.spinner.min.js","${contextPath}/static/dist/js/date-time/bootstrap-datepicker.min.js","${contextPath}/static/dist/js/date-time/bootstrap-timepicker.min.js","${contextPath}/static/dist/js/date-time/moment.min.js","${contextPath}/static/dist/js/date-time/daterangepicker.min.js","${contextPath}/static/dist/js/date-time/bootstrap-datetimepicker.min.js","${contextPath}/static/dist/js/bootstrap-colorpicker.min.js","${contextPath}/static/dist/js/jquery.knob.min.js","${contextPath}/static/dist/js/jquery.autosize.min.js","${contextPath}/static/dist/js/jquery.inputlimiter.1.3.1.min.js","${contextPath}/static/dist/js/jquery.maskedinput.min.js","${contextPath}/static/dist/js/bootstrap-tag.min.js", null]
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	  //inline scripts related to this page
		...
		//to translate the daterange picker, please copy the "examples/daterange-fr.min.js" contents here before initialization
			...
			tag_input.tag(
			  {
				...
				source: ace.vars['US_STATES'],//defined in ace.min.js >> ace.enable_search_ahead
				/**
