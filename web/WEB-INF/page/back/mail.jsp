		...
		<div class="hide message-content" id="id-message-content">
			...
			<div class="message-attachment clearfix">
				...
				<div class="attachment-images pull-right">
					...
					<div>
						<img width="36" alt="image 4" src="${contextPath}/static/dist/images/gallery/thumb-4.jpg" />
						<img width="36" alt="image 3" src="${contextPath}/static/dist/images/gallery/thumb-3.jpg" />
						<img width="36" alt="image 2" src="${contextPath}/static/dist/images/gallery/thumb-2.jpg" />
						<img width="36" alt="image 1" src="${contextPath}/static/dist/images/gallery/thumb-1.jpg" />
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	var scripts = [null,"${contextPath}/static/dist/js/bootstrap-tag.min.js","${contextPath}/static/dist/js/jquery.hotkeys.min.js","${contextPath}/static/dist/js/bootstrap-wysiwyg.min.js","${contextPath}/static/dist/js/jquery.gritter.min.js",null]
