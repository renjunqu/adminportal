...
<div class="row">
	<div class="col-xs-12">
		...
		<script type="text/javascript">
			var $path_assets = "${contextPath}/static/dist";//this will be used in gritter alerts containing images
		</script>
...
<![endif]-->
<script type="text/javascript">
	var scripts = [null,"${contextPath}/static/dist/js/jquery-ui.custom.min.js","${contextPath}/static/dist/js/jquery.ui.touch-punch.min.js","${contextPath}/static/dist/js/bootbox.min.js","${contextPath}/static/dist/js/jquery.easypiechart.min.js","${contextPath}/static/dist/js/jquery.gritter.min.js","${contextPath}/static/dist/js/spin.min.js", null]
