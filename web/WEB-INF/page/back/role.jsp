...
<script type="text/javascript">
		var scripts = [ null, "${contextPath}/static/dist/js/jqGrid/jquery.jqGrid.min.js", "${contextPath}/static/dist/js/jqGrid/i18n/grid.locale-cn.min.js", "${contextPath}/static/dist/js/fuelux/fuelux.tree.min.js", null ]
