...
<link rel="stylesheet" href="${contextPath}/static/dist/css/jquery.gritter.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/select2.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/datepicker.min.css" />
<link rel="stylesheet" href="${contextPath}/static/dist/css/bootstrap-editable.min.css" />
...
<script type="text/javascript">
	var scripts = [null,"${contextPath}/static/dist/js/jquery-ui.custom.min.js","${contextPath}/static/dist/js/jquery.ui.touch-punch.min.js","${contextPath}/static/dist/js/jquery.gritter.min.js","${contextPath}/static/dist/js/date-time/bootstrap-datepicker.min.js","${contextPath}/static/dist/js/date-time/locales/bootstrap-datepicker.zh-CN.min.js","${contextPath}/static/dist/js/select2.min.js","${contextPath}/static/dist/js/x-editable/bootstrap-editable.min.js","${contextPath}/static/dist/js/x-editable/ace-editable.min.js", null]
	        ...
	        try { 
	            ...
	            $('#avatar').editable({
	                ...
	                url: function(params) {
	                    ...
	                    //examples/profile-avatar-update.min.js
