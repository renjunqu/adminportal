...
<script type="text/javascript">
	var scripts = [null,"${contextPath}/static/dist/js/fuelux/fuelux.wizard.min.js","${contextPath}/static/dist/js/jquery.validate.min.js","${contextPath}/static/dist/js/additional-methods.min.js","${contextPath}/static/dist/js/bootbox.min.js","${contextPath}/static/dist/js/jquery.maskedinput.min.js","${contextPath}/static/dist/js/select2.min.js", null]
