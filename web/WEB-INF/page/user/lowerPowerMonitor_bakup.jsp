...
<div id="gridPanel" style="width:600px;height:600px;position: absolute;">
...
//        url: '/car/loadByCenter',
  ...
  var mapGridInit = function () {
    ...
    var cm = new Ext.grid.ColumnModel([
      ...
      {header: 'X', width: 1, dataIndex: 'positionx'},
      {header: 'Y', width: 1, dataIndex: 'positiony'},
      {header: 'State', width: 1, dataIndex: 'state'},
      {header: 'desp', width: 1, dataIndex: 'desp'},
      {header: 'mobileNo', width: 1, dataIndex: 'mobileno'},
      {
        header: '操作',
        xtype: 'actioncolumn',
        width: 0.5,
        items: [
          {
            ...
            handler: function (grid, rowIndex, colIndex) {
              ...
              console.log("===============");
              var x = record.get('positionx');
              var y = record.get('positiony');
